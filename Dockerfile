...
RUN apt -y update && apt install -y hcxtools && apt install -y --no-install-recommends kali-linux-headless
# Tools
...
RUN echo "alias scan-local='nmap -sP 192.168.1.1-254'" >> /root/.bashrc
